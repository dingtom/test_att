...
class ConvLSTMCell(nn.Module):
    """
    Implementation of the Basic ConvLSTM.  No peephole connection, no forget gate.没有窥视孔，没有遗忘之门。
    ConvLSTM:
        x - input
        ...
        f - forget gate
        o - output gate
    Reference:Convolutional LSTM Network: A Machine Learning Approach for Precipitation Nowcasting
    """
    ...
    def forward(self, inputs, c):
        ...
        #Bias included in self.W_.. initialization
